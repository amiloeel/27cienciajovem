...
?><?php
						...
						print'<h4 style="font-size: large; text-align:center; font-style: normal;">ATENÇÃO<br>Você está prestes a remover o seguinte projeto<br> de nossa base de dados:<br>
						<br></h4><h4 style="font-size: large; text-align:center; font-style: normal; color:black;">'.$nome.'</h4><br><br><h4 style="font-size: large; text-align:center; font-style: normal;">Deseja prosseguir?</h4>';
							...
							print'<form method="post" action="deletarproj.php">';
							print'<input type="hidden" name="code" value="'.$codigo.'">';
							print'<input type="hidden" name="proj" value="'.$nome.'">';
							print'<br><br><input type="submit" value="Confirmar exclusão de projeto" style="color:red; margin-left:268px; background-color: #white; border-style: none; width:280px; height:20px; margin-top:0px;"></form><br>';

							print'<div class = "nueva" align="center"><a href="../../_visualiza/proj/consulta.php"><input type="button" value="CANCELAR" class="new3" style="background-color:red;"></a></div>';
