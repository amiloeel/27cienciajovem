...
if($pre=="0"){
    $sql = "update projetos set proj='$proj', cat='$cat', escola='$escola', prof='$prof', aln1='$aln1', aln2='$aln2', pais='$pais', estado='$estado', email='$email', pre=0 where codigo='$codigo'";
}else{
    $sql = "update projetos set proj='$proj', cat='$cat', escola='$escola', prof='$prof', aln1='$aln1', aln2='$aln2', pais='$pais', estado='$estado', email='$email', pre=1 where codigo='$codigo'";
}

$sql2 = "update res set projeto='$proj' where id='$codigo'";
$sql3 = "update apr set projeto='$proj' where id='$codigo'";

$usuario = $_SESSION['nick'];

$registro = "insert into register (fulano, fez, com) values ('$usuario', 'EDITED', '$proj')";
...
<html lang="pt-br">
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section>
				<h1>Confirmação de Modificação</h1>
				<hr><br>
				...
				<br>
				<h2 style="text-align: center; color: #666;">Dados do projeto foram modificados com sucesso!</h2><br>
				<a href="../../_visualiza/proj/consulta.php"><input type="button" value="Voltar" class="btn" style="margin-left: 32%; width: 300px;"></a>
			<br><br></section>
