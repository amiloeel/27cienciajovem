		...
		<div class="containernovo">
			<nav class="novonav"><br><img src="../../y.png" style="margin-left:20%;width:500px">
				...
				<ul class="menu2" style="background-color:#666;width:800px;margin-left:2%">
					...
					<br><b><div align="center" style="font-size:45px">AVALIAR APRESENTAÇÃO</div><br><br></b>
				    ...
				    print"Oi $nomeia, tudo bem?<br>Você foi selecionado para avaliar a apresentação desse projeto porém ele ainda não está ativo.<br>Quando ele for ativado você verá o botão <b>AVALIAR</b> ao invés dessa importuna mensagem!<br><br>Para saber as datas e horários de ativação basta procurar o representante da sua categoria.";
				    print"</article></div>";
					}else{
					    $sqlx="select link from apr where id='$code'";
					    $resx=mysqli_query($conexao,$sqlx);
					    $ress=mysqli_fetch_array($resx);
					    $link=$ress[0];
					    
					    print'<br><div align="center" style="font-size:35px">Vamos começar?<br><br>Primeiro clique no botão abaixo para acessar o vídeo de apresentação do projeto:<br><br></div>';
					    
					    print'<div align="center"><a href="'.$link.'" ><li style="width: 500px;
	height: 80px;line-height: 80px;background-color:orangered;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;margin-left: 10px;list-style-type: none;font-size:40px">Assistir Vídeo</li></a><br>
</div>';

print'<br><div align="center" style="font-size:35px">Após assistir ao vídeo clique no botão abaixo para começar a avaliação!<br><br></div>';

print'<div align="center"><form method="post" action="avaliaapr.php">
<input type="hidden" name="code" value="'.$code.'">
<input type="hidden" name="nome" value="'.$nomeia.'">
<input type="submit" class="btny" value="Avaliar!" style="width: 500px;height: 80px;line-height: 80px;background-color: orangered;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;margin-left: 10px;list-style-type: none;font-size:45px">
