...
float:center;
	...
	box-sizing: border-box;
	                        "><br><div align="center"><img src="../../amarelo2.png" id="x" style="width:300px">
	                         <script type="text/javascript">
                                    if(isMobile){
				...
				<h2 id="xx" style="font-size:20px">MODO AUXILIAR</h2>
					<script type="text/javascript">
                                    if(isMobile){
				...
				<div class = "nueva" align="center">
					...
					<a><input type="button" id="xxbtn" value="Login" class="btnx" style="background-color:#916e1b;" blocked>
					<script type="text/javascript">
                                    if(isMobile){
					...
					<br><br><a><input type="button" id="xxbtn3" value="Senha" class="btnx" style="background-color:#916e1b;" blocked>
						<script type="text/javascript">
                                    if(isMobile){
					...
					<br><br><br>
						<input type="submit" id="ahah" value="ACESSAR" name="go" class="btny" style="background-color:#916e1b;"><br>
						<script type="text/javascript">
                                    if(isMobile){
                                        document.write("<br>");
