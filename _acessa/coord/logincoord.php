...
float:center;
	...
	box-sizing: border-box;
	                        "><br><div align="center"><img id="x" src="../../verde2.png" style="width:300px">
	                         <script type="text/javascript">
                                    if(isMobile){
				...
				<h2 id="xx" style="font-size:20px">MODO COORDENADOR</h2>
					<script type="text/javascript">
                                    if(isMobile){
				...
				<div class = "nueva" align="center">
					<form method="post" action="logincoordX.php">
					<a><input type="button" id="xxbtn" value="Login" class="btnx" style="background-color:#297c5f;" blocked>
					<script type="text/javascript">
                                    if(isMobile){
					...
					<br><br><a><input type="button" id="xxbtn3" value="Senha" class="btnx" style="background-color:#297c5f;" blocked>
					<script type="text/javascript">
                                    if(isMobile){
					...
					<br><br><br>
						...
						<input type="hidden" name="tipo" value="coord">
						<input type="submit" id="ahah" value="ACESSAR" name="go" class="btny" style="background-color:#297c5f;">
						<script type="text/javascript">
                                    if(isMobile){
                                        document.write("<br>");
