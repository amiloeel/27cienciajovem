...
$sql = "select codigo,proj,cat from projetos where proj like '%$filtro%' order by proj";
				...
				<?php
					...
					while($exibirRegistros = mysqli_fetch_array($consulta)){
						...
						if(!isset($vemca[2])){
						    ...
						    print"<input type='hidden' name='origem' value='base'>";
						    print"<input type='hidden' name='codigo' value='$codigo'>";
						    print"<input type='hidden' name='nome' value='$proj'>";
