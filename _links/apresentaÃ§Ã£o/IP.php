...
$sql = "select codigo,proj,cat from projetos where proj like '%$filtro%' and cat='IP' order by proj";
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				...
				<div class="nueva" align="center">
                    ...
                    print'<a href="IP.php"><input type="button" value="IP - Iniciação à Pesquisa" class="btnk" style="background-color:darkred"></a>';
				...
				<?php
					...
					while($exibirRegistros = mysqli_fetch_array($consulta)){
						...
						if(!isset($vemca[2])){
						    ...
						    print"<input type='hidden' name='origem' value='ip'>";
