...
$sql = "select codigo,proj,cat from projetos where proj like '%$filtro%' and cat='DT' order by proj";
...
<html lang="pt-br">
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				<h1 style="color:#297c5f">Links dos Vídeos dos Projetos</h1>
				<hr><br>
				...
				<div class="nueva" align="center">
                    ...
                    print"<div align='center' style='color:darkgreen'>-- Utilize esse espaço para informar o link de acesso para os <b>vídeos de apresentação</b> de cada projeto --<br><br></div>";
                    ...
                    print'<a href="DC.php"><input type="button" value="DC - Divulgação Científica" class="btnk" ></a>';
                    print'<a href="FD.php"><input type="button" value="FD - Talentos Internacionais" class="btnk" ></a>';
                    print'<a href="DT.php"><input type="button" value="DT - Desenvolvimento Tecnológico" class="btnk" style="background-color:darkmagenta"></a>';
				...
				<?php
					...
					while($exibirRegistros = mysqli_fetch_array($consulta)){
						...
						$sql2="select id,projeto,link from apr where id='$codigo'";
						...
						if(!isset($vemca[2])){
						    ...
						    print"<input type='hidden' name='origem' value='dt'>";
