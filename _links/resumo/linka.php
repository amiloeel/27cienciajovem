...
$sql = "update res set link='$link' where id='$codigo'";

$usuario = $_SESSION['nick'];

$registro = "insert into register (fulano, fez, com) values ('$usuario', 'RES LINK', '$nome')";
...
switch($origem){
    ...
    case 'ws': header("Location: WS.php");break;
    default:  header("Location: linkres.php");
}
