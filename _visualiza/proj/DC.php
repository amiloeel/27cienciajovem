...
$counter = 0;
$sql = "select * from projetos where proj like '%$filtro%' or escola like '%$filtro%' or prof like '%$filtro%' or aln1 like '%$filtro%' or aln2 like '%$filtro%' and cat='DC' order by proj";
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				...
				<hr><br><br>
					...
					<a href="DC.php"><input type="button" value=" DC - Divulgação Científica" class="btnSelect" style="background-color:darkblue"></a><br>
...
<form method="get" action="">
				    ...
				    <b>Pesquisa em DC:</b><input type="text" name="filtro" class="new" autofocus required="">
