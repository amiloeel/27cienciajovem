...
$sql = "select * from projetos where proj like '%$filtro%' or escola like '%$filtro%' or prof like '%$filtro%' or aln1 like '%$filtro%' or aln2 like '%$filtro%' order by proj";
			...
			<section class="nova">
				...
				<?php
					...
					while($exibirRegistros = mysqli_fetch_array($consulta)){
						...
						print'<div align=left style="Color:'.$Colorx.'">'.$codigo.' </div>';
						print"<b>$proj</b>";
						echo '<b><div align=left style="Color:'.$Colory.'">'.$cat.'</div></b>';
						print"$escola<br>";
							print"<i>$prof<br></i>";
