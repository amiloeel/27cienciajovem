...
$counter = 0;
$sql = "select * from projetos where proj like '%$filtro%' or escola like '%$filtro%' or prof like '%$filtro%' or aln1 like '%$filtro%' or aln2 like '%$filtro%' and cat='IP' order by proj";
...
<html lang="pt-br">
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				<h1>Iniciação à Pesquisa</h1>
				<hr><br><br>

				

					<div class = "nueva" align="center">
					<a href="IP.php"><input type="button" value=" IP - Iniciação à Pesquisa " class="btnSelect" style="background-color:darkred"></a>
...
<form method="get" action="">
				    <b>Pesquisa em IP:</b><input type="text" name="filtro" class="new" autofocus required>
