...
$counter = 0;
$sql = "select * from projetos where proj like '%$filtro%' or escola like '%$filtro%' or prof like '%$filtro%' or aln1 like '%$filtro%' or aln2 like '%$filtro%' and cat='WS' order by proj";
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				...
				<hr><br><br>
					...
					<a href="WS.php"><input type="button" value=" WS - Workshop de Química" class="btnSelect" style="background-color:#e66700"></a><br><br><br>
					</div>

<form method="get" action="">
				    <b>Pesquisa em WS:</b><input type="text" name="filtro" class="new" autofocus required>
