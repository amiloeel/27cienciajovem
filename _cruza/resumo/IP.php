...
$sql = "select codigo,proj,cat,escola,res1,res2,res3 from projetos where proj like '%$filtro%' or escola like '%$filtro%' and cat='IP' order by proj";
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				...
				<div class = "nueva" align="center">
					<a href="IP.php"><input type="button" value=" IP - Iniciação à Pesquisa " class="btn" style="background-color: darkred;"></a>
