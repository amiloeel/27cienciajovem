...
$sql = "select codigo,proj,cat,escola,res1,res2,res3 from projetos where proj like '%$filtro%' or escola like '%$filtro%' and cat='DT' order by proj";
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				...
				<div class = "nueva" align="center">
					...
					<a href="DT.php"><input type="button" value=" DT - Desenvolvimento Tecnológico" class="btn" style="background-color: darkmagenta;"></a>
				...
				<?php
					...
					print "<i><b>$counter2</b> registros encontrados<br></i>	";
					print "<br><br>";
					...
					while($exibirRegistros = mysqli_fetch_array($consulta)){
						...
						$res1 = $exibirRegistros[4];
						$res2 = $exibirRegistros[5];
						$res3 = $exibirRegistros[6];
						$fim = 0;

						if($cat == 'DT'){

						$sql2 = "select fim,link from res where id='$codigo'";
			...
			echo'	<br><form method="post" action="detalheres.php">
				...
				<input type="hidden" name="origem" value="DT">
