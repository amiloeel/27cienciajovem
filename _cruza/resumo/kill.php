...
if($ava=='1'){
	$sql2 = "update res set avaliador1='x' where id='$code'";
}else if($ava=='2'){
	$sql2 = "update res set avaliador2='x' where id='$code'";
}else{
	$sql2 = "update res set avaliador3='x' where id='$code'";
}

$registro = "insert into register (fulano, fez, com, etb) values ('$usuario', 'RES UNASGN', '$avaliador', '$proj')";
...
<html lang="pt-br">
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				<h1>Confirmação de Remoção - Resumo</h1>
				<hr><br>
