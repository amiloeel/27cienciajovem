...
$sql = "select codigo,proj,cat,escola,res1,res2,res3 from projetos where proj like '%$filtro%' or escola like '%$filtro%' and cat='IC' order by proj";
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				...
				<div class = "nueva" align="center">
					...
					<a href="IC.php"><input type="button" value=" IC - Incentivo à Pesquisa" class="btn" style="background-color: deeppink;"></a>
			...
			echo'	<br><form method="post" action="detalheres.php">
				...
				<input type="hidden" name="origem" value="IC">
