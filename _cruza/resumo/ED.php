...
$sql = "select codigo,proj,cat,escola,res1,res2,res3 from projetos where proj like '%$filtro%' or escola like '%$filtro%' and cat='ED' order by proj";
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				...
				<div class = "nueva" align="center">
					...
					<a href="ED.php"><input type="button" value=" ED - Educação Científica" class="btn" style="background-color:#916e1b;"></a>
			...
			echo'	<br><form method="post" action="detalheres.php">
				...
				<input type="hidden" name="origem" value="ED">
