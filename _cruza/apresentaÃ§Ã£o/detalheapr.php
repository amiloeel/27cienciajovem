...
$sql = "select codigo,proj,cat,escola, nota1,nota2,nota3 from projetos where codigo='$code'";
$sql2 = "select id,avaliador1, avaliador2,avaliador3,a,b,c, fim,link from apr where id='$code'";
...
<html lang="pt-br">
	...
	height: 50px;line-height: 50px;background-color: #e34f4f;color: white;margin-top: 5px;box-sizing: border-box;padding-left: 10px;text-align:center;margin-left: 10px;list-style-type: none;">Encerrar Sessão</li></a><br>
			...
			<section class="nova">
				<h1 style="color:#297c5f">Detalhes da Avaliação da Apresentação</h1>
				<hr><br>
				...
				<?php
					...
					$exibirRegistros2 = mysqli_fetch_array($consulta2);
						...
						$nota1 = $exibirRegistros2[4];
						$nota2 = $exibirRegistros2[5];
						$nota3 = $exibirRegistros2[6];
...
//---------------------------------------------------------------//
				...
				<input type="submit" name="edit" value="Remover Atribuição" class="new" style="color:white;width:270px;background-color:#222;border:none">
					...
					print '</div>';
						...
						echo '<br><a href="cruzaapr.php"><input type="button" class=new value="VOLTAR" 
